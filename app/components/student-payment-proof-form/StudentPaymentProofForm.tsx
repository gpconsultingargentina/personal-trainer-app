...
interface StudentPaymentProofFormProps {
  studentId: string
  studentName: string
  plans: Plan[]
}

export default function StudentPaymentProofForm({
  studentId,
  studentName,
  plans,
}: StudentPaymentProofFormProps) {
