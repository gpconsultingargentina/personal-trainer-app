  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-gray-600">Informacion de tu cuenta</p>
      </div>
      ...
      <div className="bg-white shadow rounded-lg">
        ...
        <div className="px-6 py-4 space-y-4">
          ...
          <div>
            ...
            <p className="mt-1 text-gray-900">{student.phone || 'No registrado'}</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white shadow rounded-lg">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-medium text-gray-900">Entrenamiento</h2>
        </div>
        ...
        <div className="px-6 py-4 space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-500">Precio por clase</label>
            <p className="mt-1 text-gray-900">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-500">Horario habitual</label>
            {student.usual_schedule && student.usual_schedule.length > 0 ? (
              ...
              <p className="mt-1 text-gray-500">No definido</p>
            )}
          </div>
        </div>
      </div>
